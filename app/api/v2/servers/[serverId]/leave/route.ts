/**
 * Leave Server API Route - Clean Architecture Implementation
 */
...
// PATCH /api/v2/servers/[serverId]/leave - Leave the server
export async function PATCH(
  ...
  try {
    ...
    const result = await useCases.leaveServer.execute({
